...
serve(async (req) => {
  ...
  try {
    ...
    if (req.method === "POST") {
      ...
      console.log("calendar callback URI:", redirectUri);
      ...
      authUrl.searchParams.set(
        "scope",
        "https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/calendar.send"
      );
      ...
      console.log("Generated calendar auth URL:", authUrl.toString());
