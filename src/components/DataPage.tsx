        ...
        <Tabs defaultValue="integrations" className="w-full">
          ...
          <TabsContent value="integrations" className="space-y-4">
            <div className="grid gap-4">
              ...
              return <Card key={integration.type} className="bg-gray-800 border-gray-700">
                    ...
                    <CardContent>
                      {integration.connected ? <div className="space-y-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center">
                    ...
                    <input id="file-upload" type="file" accept=".txt,.md,.csv" onChange={handleFileUpload} className="hidden" />
                  </div>
                </div>
              </CardContent>
            </Card>

            {customDocs.length > 0 && <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {customDocs.map((doc, index) => <div key={doc.id}>
                        <div className="flex items-center justify-between p-3 bg-gray-900 rounded-lg">
                          ...
                          <Button size="sm" variant="ghost" onClick={() => removeCustomDoc(doc.id)} className="text-red-400 hover:text-red-300">
                            <Trash2 size={16} />
                          </Button>
                        </div>
